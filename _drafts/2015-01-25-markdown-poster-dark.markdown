...
Paragraphs can be written like so. <span class="evidence">A paragraph is the basic block of Markdown</span>. A paragraph is what text will turn into when there is no reason it should become anything else.
